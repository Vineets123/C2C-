...
public class view_exam extends Activity {
	String ip=new  ip().callip();
	SharedPreferences sp;
	Editor myedit;
	String u_id, top_id;
	ProgressDialog pDialog = null;
	String URL_ChapDownload = ip+"exam_Download.php";
...
String id,file;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sp = PreferenceManager.getDefaultSharedPreferences(view_exam.this);
		myedit = sp.edit();
	...
	public void downloadFile() {
		...
		request.setDestinationInExternalFilesDir(view_exam.this, null,
				"" + file);
...
//
	...
	private class GetChaps extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(view_exam.this);
			pDialog.setMessage("Wait..");
			pDialog.setCancelable(false);
			pDialog.show();
		...
		protected void onPostExecute(Void result) {
			...
			ChapterAdapter_adapt ta = new ChapterAdapter_adapt(view_exam.this, TopList);
			lv.setAdapter(ta);
