...
import geter_seter.adpt_time_table;
import geter_seter.time_getset;
...
public class view_Time extends Activity {
	String ip=new  ip().callip();
	SharedPreferences sp;
	Editor myedit;
	String u_id, top_id;
	ProgressDialog pDialog = null;
	String URL_ChapDownload = ip+"view_time.php";
//	String URL_SHEDULE = "http://192.168.1.11:8084/ServerCOde/Shedule.php";
	String URL_DOWNLOAD;
	ArrayList<time_getset> TopList = new ArrayList<time_getset>();
	ListView lv;
...
String id,file;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sp = PreferenceManager.getDefaultSharedPreferences(view_Time.this);
		myedit = sp.edit();
		...
		lv.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View arg1,
					int pos, long arg3) {
				// TODO Auto-generated method stub
				time_getset c = (time_getset) parent.getItemAtPosition(pos);
				id = c.getId();
				file = c.getFile();
	...
	public void downloadFile() {
		...
		request.setDestinationInExternalFilesDir(view_Time.this, null,
				"" + file);
...
//
	...
	private class GetChaps extends AsyncTask<Void, Void, Void> {
				...
				try {
					...
					if (jsonobj != null) {
						...
						for (int i = 0; i < pre.length(); i++) {
							...
							Log.e("jsonobjct", ">" + job);
							time_getset c = new time_getset(job.getString("id"),
								
								job.getString("file"),job.getString("date"));
		...
		protected void onPostExecute(Void result) {
			...
			adpt_time_table ta = new adpt_time_table(view_Time.this, TopList);
			lv.setAdapter(ta);
