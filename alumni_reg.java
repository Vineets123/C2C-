...
import com.example.c2e.student_reg.getsubmit;

public class alumni_reg extends Activity {
	String ip=new  ip().callip();
	private String URL_USERREG = ip+"alumni_reg.php";

	EditText fname, dob, add, sph, stdem, studuname, studpword,
			 cource, bach,occ;
	RadioGroup rg;
	RadioButton rb;
	Button register;
	...
	String stud_fname, stud_dob, stud_add, stud_phone, stud_email,
			stud_uname, stud_pword, selected_course,
...
int user_id,login_id;
	...
	protected void onCreate(Bundle savedInstanceState) {
...

		{
			...
			bach = (EditText) findViewById(R.id.batch);
			...
			register.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					stud_dob = dob.getText().toString();
					stud_add = add.getText().toString();
					stud_phone = sph.getText().toString();
					stud_email = stdem.getText().toString();
					...
					if (stud_fname.equals("") 
							|| stud_dob.equals("") || stud_add.equals("")
							|| stud_phone.equals("") || stud_email.equals("")
							|| stud_uname.equals("") || stud_pword.equals("")
							 || gender.equals("")) {

						Toast.makeText(alumni_reg.this,
						...
						Intent ob = new Intent(alumni_reg.this, alumni_home.class);
						startActivity(ob);
		 ...
		 Intent ob = new Intent(getApplicationContext(), alumni_home.class);
		 startActivity(ob);
		}
	...
	nameValuePairs.add(new BasicNameValuePair("stud_dob", stud_dob));
				...
				try {
					...
					if (jsonObj != null) {
						...
						for (int i = 0; i < loginarray.length(); i++) {
							...
							myedit.putInt("alumni_id", user_id);
							myedit.putInt("alumni_login", login_id);
