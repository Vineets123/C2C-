...
public class staff_reg extends Activity {
	...
	private String URL_USERREG = ip+"staff_reg.php";
			...
			register.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (stud_fname.equals("") || stud_lname.equals("")
							...
							|| stud_cpass.equals("") || gender.equals("")) {

						Toast.makeText(staff_reg.this, "All Fields Nessessary",
						...
						Toast.makeText(staff_reg.this,
								"YOur Registration is Success",
								Toast.LENGTH_SHORT).show();
						Intent ob = new Intent(staff_reg.this, staff_home.class);
						startActivity(ob);
				...
				try {
					...
					if (jsonObj != null) {
						...
						for (int i = 0; i < loginarray.length(); i++) {
							...
							myedit.putInt("staff_id", user_id);
							myedit.putInt("staff_login", login_id);

							myedit.commit();

							Log.e("staffname", stud_uname);
